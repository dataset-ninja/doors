...
RELEASE_DATE: Optional[str] = "2022-09-23"  # e.g. "YYYY-MM-DD"
...
DOWNLOAD_ORIGINAL_URL: Optional[Union[str, dict]] = (
    "https://zenodo.org/records/7107409/files/DOORS.zip?download=1"
)
...
PAPER: Optional[Union[str, List[str], Dict[str, str]]] = "https://arxiv.org/pdf/2210.16253.pdf"
BLOGPOST: Optional[Union[str, List[str], Dict[str, str]]] = None
REPOSITORY: Optional[Union[str, List[str], Dict[str, str]]] = None

CITATION_URL: Optional[str] = None
AUTHORS: Optional[List[str]] = ["Mattia Pugliatti", "Francesco Topputo"]
AUTHORS_CONTACTS: Optional[List[str]] = ["mattia.pugliatti@polimi.it"]

ORGANIZATION_NAME: Optional[Union[str, List[str]]] = (
    "Department of Aerospace Science and Technology, Italy"
)
ORGANIZATION_URL: Optional[Union[str, List[str]]] = "https://www.polimi.it/en"
